...
PASSO 4: APÓS APARECER O "Root@Archiso" TIRE O PENDRIVE DO PC E DIGITE: pacman -Sy git --noconfirm; git clone https://github.com/Divinp12/AutoArch.git; pacman -Rsc git --noconfirm; mv AutoArch/e1.sh ~; chmod 777 e1.sh; ./e1.sh

FINAL: PARTICIONE O HD COM 1GB, 20GB, "resto", ESPERE E DIVIRTA-SE ;)
